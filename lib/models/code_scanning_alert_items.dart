...
class CodeScanningAlertItems {
  ...
  /// Converts a `Map<String, dynamic>` to a [CodeScanningAlertItems].
  ...
  static CodeScanningAlertItems? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return CodeScanningAlertItems.fromJson(json);
  }
  ...
  /// Converts a [CodeScanningAlertItems] to a `Map<String, dynamic>`.
