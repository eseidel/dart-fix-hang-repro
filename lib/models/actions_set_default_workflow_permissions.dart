...
class ActionsSetDefaultWorkflowPermissions {
    ...
    return parseFromJson(
      ...
      () => ActionsSetDefaultWorkflowPermissions(
        ...
        canApprovePullRequestReviews:
            ActionsCanApprovePullRequestReviews.maybeFromJson(
  ...
  static ActionsSetDefaultWorkflowPermissions? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ActionsSetDefaultWorkflowPermissions.fromJson(json);
  }
  ...
  /// Converts an [ActionsSetDefaultWorkflowPermissions]
