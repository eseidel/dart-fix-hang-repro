...
class CodeScanningAlert {
  ...
  /// Converts a `Map<String, dynamic>` to a [CodeScanningAlert].
  ...
  static CodeScanningAlert? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
  ...
  /// Converts a [CodeScanningAlert] to a `Map<String, dynamic>`.
