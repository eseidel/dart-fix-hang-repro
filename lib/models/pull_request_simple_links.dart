...
class PullRequestSimpleLinks {
  ...
  /// Converts a `Map<String, dynamic>` to a [PullRequestSimpleLinks].
  ...
  static PullRequestSimpleLinks? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return PullRequestSimpleLinks.fromJson(json);
  }
  ...
  /// Converts a [PullRequestSimpleLinks] to a `Map<String, dynamic>`.
