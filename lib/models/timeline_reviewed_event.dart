...
class TimelineReviewedEvent {
  ...
  static TimelineReviewedEvent? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return TimelineReviewedEvent.fromJson(json);
  }
  ...
  /// Converts a [TimelineReviewedEvent] to a `Map<String, dynamic>`.
