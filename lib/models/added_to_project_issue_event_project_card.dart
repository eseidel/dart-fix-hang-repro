...
class AddedToProjectIssueEventProjectCard {
  ...
  static AddedToProjectIssueEventProjectCard? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return AddedToProjectIssueEventProjectCard.fromJson(json);
  }
  ...
  /// Converts an [AddedToProjectIssueEventProjectCard]
  ...
  bool operator ==(Object other) {
    ...
    return other is AddedToProjectIssueEventProjectCard &&
        id == other.id &&
        url == other.url &&
