...
class PullRequestBase {
  ...
  /// Converts a `Map<String, dynamic>` to a [PullRequestBase].
  ...
  static PullRequestBase? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return PullRequestBase.fromJson(json);
  }
  ...
  /// Converts a [PullRequestBase] to a `Map<String, dynamic>`.
