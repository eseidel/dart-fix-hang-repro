...
/// {@template review_request_removed_issue_event}
/// Review Request Removed Issue Event
/// Review Request Removed Issue Event
/// {@endtemplate}
@immutable
class ReviewRequestRemovedIssueEvent {
  /// {@macro review_request_removed_issue_event}
  ...
  /// Converts a `Map<String, dynamic>` to a [ReviewRequestRemovedIssueEvent].
  ...
  static ReviewRequestRemovedIssueEvent? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ReviewRequestRemovedIssueEvent.fromJson(json);
  }
  ...
  /// Converts a [ReviewRequestRemovedIssueEvent] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is ReviewRequestRemovedIssueEvent &&
        this.id == other.id &&
