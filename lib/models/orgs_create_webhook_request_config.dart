...
/// {@template orgs_create_webhook_request_config}
/// Key/value pairs to provide settings for this webhook.
/// {@endtemplate}
@immutable
class OrgsCreateWebhookRequestConfig {
  /// {@macro orgs_create_webhook_request_config}
  ...
  /// Converts a `Map<String, dynamic>` to an [OrgsCreateWebhookRequestConfig].
  ...
  static OrgsCreateWebhookRequestConfig? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return OrgsCreateWebhookRequestConfig.fromJson(json);
  }
  ...
  /// Converts an [OrgsCreateWebhookRequestConfig] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is OrgsCreateWebhookRequestConfig &&
        url == other.url &&
